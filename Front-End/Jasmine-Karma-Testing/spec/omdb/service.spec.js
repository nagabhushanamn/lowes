...
describe('omdb', function() {
	...
	it(' shud serach by query', function() {
		var response;
		$httpBackend.when('GET', 'http://omdbapi.com/?apikey=3d569349&s=star%20wars')
	...
	it("shud find by id", function() {
		var response;
		$httpBackend.when('GET', 'http://omdbapi.com/?apikey=3d569349&i=tt0076759')
	...
	it("shud return error", function() {
		var response;
		$httpBackend.when('GET', 'http://omdbapi.com/?apikey=3d569349&i=123')
